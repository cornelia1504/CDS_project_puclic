...
#id_2_dl()
input= '/home/guest/Downloads/8etl.cif'
# def cif_to_pdb():
#     #os.system('obabel input -opdb -O 8etl.pdb')
#     with pymol2.PyMOL() as pymol:
#         pymol.cmd.load(input, 'myprotein')
#         pymol.cmd.save(input.replace('.cif', '.pdb'), selection='myprotein')
